...
const ChatGPTResponse = ({ word }) => {
    ...
    return (_jsxs("div", { children: [_jsx("button", { onClick: fetchResponse, children: "Start Game" }), _jsx("p", { children: response || "Waiting for your guess..." }), _jsx("p", { children: gameState.hint }), _jsx("p", { children: gameState.gameOver ? "Game Over. Click to start a new game." : "Guess the word!" }), _jsxs("p", { children: ["Attempts: ", gameState.attempts] }), showConfetti && _jsx(Confetti, {})] }));
};
